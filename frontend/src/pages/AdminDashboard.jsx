  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (updateEventId) {
        ...
        alert("Event updated sccessfully");
      } else {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="bg-black text-white rounded-2xl p-6 sm:p-8 mb-8 shadow-lg flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
        ...
        >
          {!showEventForm ? "+ Create New Event" : "Cancel"}
        </button>
      </div>
                  ...
                  >
                    ...
                    <div className=" flex gap-2 ">
                      <button
                        ...
                        className="w-full sm:w-auto text-gray-500 hover:text-white hover:bg-yellow-500 border border-gray-200 px-2.5 py-2 rounded-lg text-sm font-bold transition shadow-sm shrink-0"
                      >
                        <FiEdit />
                      </button>
                      <button
                        onClick={() => handleDeleteEvent(event._id)}
                        className="w-full sm:w-auto text-gray-500 hover:text-white hover:bg-red-500 border border-gray-200 px-2.5 py-2 rounded-lg text-sm font-bold transition shadow-sm shrink-0"
                      >
                        <FiDelete fontSize={17} />
                      </button>
                    </div>
                  </li>
                ))
